...
CALC MenY_last_vaccine IS HIST(MenY,-1,vaccine)	
...
FOLDER 0 "ACWY (Copie)"
  ...
  FOLDER 1 "RF+ (Copie)"
    ...
    FOLDER 11 "LD is NIMENRIX, MENVEO or MENQUADFI (Copie)"
      IF ANY OF
      CALC:MenY_last_vaccine = VAC0486 # NIMENRIX
      CALC:MenY_last_vaccine = VAC0594 #MenQuadfi
      CALC:MenY_last_vaccine = VAC0141 #MENVEO
