...
CALC MenW_last_vaccine IS HIST(MenW,-1,vaccine)
...
FOLDER 0 "ACWY (Copie)"
  ...
  FOLDER 1 "RF+ (Copie)"
    ...
    FOLDER 11 "LD is NIMENRIX, MENVEO or MENQUADFI (Copie)"
      IF ANY OF
      CALC:MenW_last_vaccine = VAC0486 # NIMENRIX
      CALC:MenW_last_vaccine = VAC0594 #MenQuadfi
      CALC:MenW_last_vaccine = VAC0141 #MENVEO
