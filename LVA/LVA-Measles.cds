...
SYNTH HIST-MMR "MMR - History of measles, mumps and rubella" IS ALL OF
...
FOLDER 0 "Common to measles, mumps and rubella"
  ...
  FOLDER 9 "Further information"
    ...
    RULE 9/01 "If to do, Born ≥ 1957: Message"
      WHEN Recommended
      IF ALL OF
        BASE:dob>=1957-01-01
...
FOLDER 1 "Only for measles"
  ...
  RULE 1/03 "History of measles+: message"
    WHEN Recommended
    IF ALL OF
      COND:C146 "History of measles" = true
      SYNTH:HIST-MMR "MMR - History of measles, mumps and rubella" = false
...
MESSAGE MSG78 Summary ANY PRIO 0
