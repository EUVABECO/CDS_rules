...
FOLDER 0 "Common"
  ...
  FOLDER 01 "Zero dose"
    ...
    RULE 01/01 "0 dose: To do in 2m old"
      IF CALC:Age>=15d
      DO Recommended
        Status DUE
        Age 2m
  ...
  FOLDER 03 "Last dose is a booster OR ≥ 6 doses"
    ...
    CALC:Diph_doses_received>=6

    RULE 03/01 "Booster+, LD [5-13y] old: DUE 14y old and 5y after LD"
      IF CALC:Diph_age_at_last_dose in 5y..13y
      DO Recommended
        Status DUE
        Age 14y
        Delay 5y from CALC:Diph_last_dose_date
    ...
    RULE 03/02 "Booster+, LD[14-19y] old: To do from 25y old"
      IF ALL OF
        CALC:Age>=2m
        CALC:Diph_age_at_last_dose in 14y..19y
      DO Recommended
        Status DUE
        Age 25y
    END RULE 03/02
    ...
    RULE 03/04 "Booster+, LD ≥ 20y old: To do 10y after LD"
      IF CALC:Diph_age_at_last_dose>=20y
      DO Recommended
        Status DUE
