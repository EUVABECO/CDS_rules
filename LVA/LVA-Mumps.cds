...
FOLDER 0 "Common to measles, mumps and rubella"
  ...
  FOLDER 9 "Further information (Copie)"
    ...
    RULE 9/06 "If To do, Born ≥ 01/01/1957, 0 dose: message vaccination scheme"
      WHEN Recommended
...
FOLDER 1 "Only for mumps"
  ...
  RULE 1/03 "History of mumps+: message"
    WHEN Recommended
    IF ALL OF
      SYNTH:HIST-MMR "MMR - History of measles, mumps and rubella" = false
...
MESSAGE MSG77 Comments ANY PRIO 0
  "Despite a history of mumps, vaccination with a trivalent vaccine is indicated."@en
 END MESSAGE MSG77
